...
<div class="posicion espaciado centrado">
	<div>
		...
		if ($_SERVER['REQUEST_URI'] === '/php-says/derrota.php') {
			echo
				...
				<form action='./game.php' method='POST'>
						<button class='boton espaciado' type='submit' name= 'repeat' value=$nivel  accesskey=''>REPETIR</button>
					</form>
					</div>";
		}
		//TODO
		if ($_SERVER['REQUEST_URI'] === '/php-says/victoria.php') {
			...
			echo "<div><form action='./game.php' method='POST'>
			<button class='boton espaciado' type='submit' name='next' value=$nextLevel accesskey=''>SIGUIENTE</button>
		</form>
		</div>";
		}
		?>